...
const TrainingRating = () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        if (selectedSchoolYear === "all") {
          ...
          fetchTrainingRatingsForYear(selectedSchoolYear);
        }
      }
    } catch (error) {
  ...
  const getFilteredStudentsForBulk = () => {
    if (!trainingRatings) return [];

    let filtered = trainingRatings.filter((item) => {
      const matchesSearch =
        bulkSearchTerm === "" ||
  ...
  const handleBulkSubmitUpdate = async () => {
    ...
    if (!bulkUpdateData.trainingRating) {
      handleNotify("warning", "Cảnh báo", "Vui lòng chọn xếp loại rèn luyện");
      return;
    }
  ...
  return (
    <>
              ...
              <div className="font-bold p-5 flex justify-between items-center border-b border-gray-200 dark:border-gray-700">
                <div className="text-gray-900 dark:text-white">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    Quản lý và xem xếp loại rèn luyện
                  </p>
                </div>
                <button
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white text-center">
                              <div className="flex justify-center space-x-2">
                                <button
                                  ...
                                  title="Cập nhật xếp loại rèn luyện"
                                  onClick={(e) => {
                                    e.stopPropagation();
                        ...
                        <tr>
                          ...
                          >
                            <div className="flex flex-col items-center">
                              ...
                              <p className="text-sm">
                                Không tìm thấy dữ liệu xếp loại rèn luyện nào
                              </p>
                            </div>
                          </td>
                        </tr>
      ...
      {/* Modal cập nhật xếp loại rèn luyện */}
      ...
      {showBulkUpdateModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
          ...
          <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white">
                Cập nhật đồng loạt xếp loại rèn luyện
              </h2>
              <button
                onClick={() => {
                  setShowBulkUpdateModal(false);
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  >
                    <Select
                      value={bulkUpdateData.trainingRating}
                      onChange={(value) =>
                ...
                <div>
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white">
                      Danh sách sinh viên ({getFilteredStudentsForBulk().length}
                      )
                    </h3>
